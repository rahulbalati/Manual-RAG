"""Generate chunks from all document sections."""

from service_manual_rag.domain.models import Chunk, ChunkType, Document, Section
from service_manual_rag.processors.error_table_split import (
