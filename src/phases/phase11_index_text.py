"""Phase 11: Index text chunks in Chroma with Azure OpenAI embeddings."""

import chromadb

from src.azure_openai_client import embed_texts, get_azure_openai_client
from src.domain.models import Chunk
from src.utils import chroma_path, document_id_for_pdf, load_chunks, PDF_PATH
...
def main() -> None:
    print("Phase 11: Indexing text chunks in Chroma")
    chunks = load_chunks()
