...
from src.processors.text_spans import extract_text_spans
from src.utils import PDF_PATH, save_document, save_text_spans, stable_id
...
def main() -> None:
    print(f"Phase 2: Parsing {PDF_PATH.name}")
    document, text_spans = parse_pdf(PDF_PATH)
